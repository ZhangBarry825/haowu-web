...
Page({
                    ...
                    if(res.tapIndex==0){
                        wx.request({
                            ...
                            success: function(res) {
                                ...
                                wx.redirectTo({
                                    url: "/pages/detail/mydetail?mydynamicId="+that.data.dynamicId
                                })
                            }
                        })
    ...
    //     }else {
    //         console.log({
    //             dynamicId:this.data.data.dynamic.dynamicId,
    //             dynamicToken:this.data.data.dynamic.token,
    //             f_id:'',
    ...
    subReturnComm:function () {
        ...
        if(that.data.returnText==''){
            ...
            console.log({
                ...
                top:2,
                token:that.data.token,
                otherName:that.data.returnName
            })
            var that=this
            wx.request({
                url: app.globalData.url+'/dynamic/comment',
